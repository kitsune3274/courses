...
# не очень хороший алгоритм, но рабочий (для небольшого текста подходит)
def decrypt(encryption: str) -> str:
    """
    Расшифровывает послание, переданное в encryption
    '.' - убрать точку, оставить символ перед точкой
    '..' - убрать точки и символ стоящий перед ними
    Parameters:
        encryption: str
    ...
    Raises:
        IndexError
            если строка состоит из 1-го символа
    """
    temp = list(encryption)
    while "." in temp:
