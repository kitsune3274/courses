...
class JsonAdapter(logging.LoggerAdapter):
    ...
    def process(self, msg, kwargs):
        """
        Преобразование msg в валидную json строку
        Parameters:
            msg
            ...
            kwargs
                ключевые слова
        Returns:
            валидная json-строка и/ли ключевые слова
        """
        new_message = str(json.dumps(msg, ensure_ascii=False).encode('utf-8').decode())
